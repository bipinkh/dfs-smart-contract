...
contract SubNode is IsPostMan{
	...
	function checkSubNodeStatus(address postManAddress,address subNodeAddress)public view onlyPostMan(postManAddress) returns(bool){
		subNodeInfo[] memory totalSubNodes=subNodeMaps[postManAddress];
	...
	function getSubNodeList(address postManAddress)public view onlyPostMan(postManAddress)returns(address[]){
